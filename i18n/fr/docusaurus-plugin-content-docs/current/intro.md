...
:::info
Si vous ne souhaitez pas profondément modifier votre calculatrice, [il y a toujours certaines choses que vous pouvez faire](/docs/unlock/what-to-do-locked)
:::

#### Pré-requis

- Calculatrice Numworks
- Driver si vous avez Windows ou Linux: ouvrez la [page de récupération](https://numworks.com/rescue) sur le site de Numworks et elle va vous le donner et vous dire comment l'installer. **Ne branchez pas votre calculatrice pour être sur que vous ne la bloquiez pas**. Si vous avez un macOS, vous n'en avez pas besoin.
...
|------------------|----------------------------------------------------------------|
| N0100            | [Votre calculatrice est déja déverrouillée, choisisez un OS Custom](/docs/cfw/choose-a-cfw) |
| N0110            | [Vérifiez si votre calculatrice est verrouillée](/docs/unlock/n0110-is-locked) |
| N0115 - N0120    | [Vous ne pouvez pas installer d'OS Custom dessus. En revanche il y a toujours certaines choses que vous pouvez faire](/docs/unlock/what-to-do-locked) |
